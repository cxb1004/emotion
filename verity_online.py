...
file_corpus_pos_53kf_txt = baseConfig.get_value('py-project', 'corpus_pos_53kf_filename')
file_corpus_neg_53kf_txt = baseConfig.get_value('py-project', 'corpus_neg_53kf_filename')
